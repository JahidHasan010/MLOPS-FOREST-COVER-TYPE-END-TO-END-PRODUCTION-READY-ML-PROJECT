import sys
from src.forest_cover.cloud_storage.aws_storage import SimpleStorageService
from src.forest_cover.exeception import CustomException
from src.forest_cover.logger import logging
from src.forest_cover.entity.artifact_entity import ModelPusherArtifact, ModelTrainerArtifact
from src.forest_cover.entity.config_entity import ModelPusherConfig
...
class ModelPusher:
    def __init__(self, model_trainer_artifact: ModelTrainerArtifact,
        ...
        self.sensor_estimator = ForestEstimator(bucket_name=model_pusher_config.bucket_name,
